...
Serves the web dashboard at http://localhost:5002
...
# Configure template folder (Flask looks here by default)
app.template_folder = 'templates'

@app.route('/')
def index():
    """Serve the web dashboard from templates/dashboard.html"""
    return render_template('dashboard.html')

# Legacy inline HTML support (if templates folder doesn't exist)
